...
from github.exports.ui.helpers import (
...
def export():
    ...
    merge_rate_df = get_merge_rate_dataframe(content)
    ...
    open_to_merge_df = get_open_to_merge_dataframe(content)
    ...
    pr_size_metrics_df = get_pr_size_metrics_dataframe(content)
    ...
    open_to_merge_by_author = get_open_to_merge_for_last_week_dataframe(content)
    ...
    time_to_review_df = get_time_to_review_dataframe(content)
    ...
    time_to_open_df = get_time_to_open_dataframe(content)
    ...
    time_to_merge_df = get_time_to_merge_dataframe(content)
